# dracon-warden v0.113.11 (2026-09-16)

Git filter encryption and repository hardening for secrets at rest.

## What's Changed

- Bump version to 0.113.11
- (See CHANGELOG.md for the full list of changes in this release)

## Install

```bash
cargo install dracon-warden --version 0.113.11
```
...
**Full Changelog**: https://github.com/DraconDev/dracon-utilities/compare/dracon-warden-v0.113.10...v0.113.11
